...
const allowed=['index.html','404.html','favicon.svg','favicon.png','favicon.ico','apple-touch-icon.png','icon-192.png','icon-512.png','og-image.png','robots.txt','sitemap.xml','site.webmanifest','.nojekyll','assets','notes','labs','work','deep-dives','inference','evals','systems'];
