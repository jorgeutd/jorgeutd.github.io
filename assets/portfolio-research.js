...
function familyDiagram(mode){
 ...
 return `<svg class="family-diagram" viewBox="0 0 700 ${mode==='seq2seq'?244:144}" role="img" aria-label="${familyData[mode].name} architecture: ${escape(familyData[mode].description)}">${inner}</svg>`;
}
